...
INC = -I/usr/include  -I/usr/local/include -I$(IFORTDIR)/composerxe/linux/mpi/include64 -I$(HOME)/include

# linking
LDPATH = -L$(HOME)/lib $(LDFLAGS) -lmpi_mt  -L$(IFORTDIR)/composerxe/linux/mpi/lib64 # -L$(IFORTDIR)/impi_5.0.1/lib64

# libraries
LIBS = $(MKLLIB)  -lpthread  -lm

# optimization
OP= -O3  -coarray=shared -coarray-num-images=8 # -coarray-config-file=./cafconf  #-coarray-num-images=16  #-parallel
